...
with colc:
    ...
    with colz:
        ...
        st.image("./pages/assets/pd.svg", width=28)
        st.write(
            "[https://www.linkedin.com/in/roman-krafft-1b034620b/](%s)"
            % "https://www.linkedin.com/in/roman-krafft-1b034620b/"
        )
...
with colz:
    st.write("")
    st.write(
        "[https://github.com/Scherzan/you-shall-not-pass](%s)"
        % "https://github.com/Scherzan/you-shall-not-pass"
    )
