...
tab1, tab2, tab3 = st.tabs(["vulnerabilities", "gradio", "code injection"])
...
#
#
## don't use pyscript you want to trigger the code run and then capture the output from your consoile
#
