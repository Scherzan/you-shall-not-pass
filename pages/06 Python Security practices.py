...
tab0, tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8   = st.tabs(["coding practices","package management", "code scan", "pypi and open source", "stay informed", "lockfiles", "hashes", "dep trees", "environment example"])
